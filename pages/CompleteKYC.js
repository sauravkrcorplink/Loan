...
//       return;
//     }
//     router.push(`/AadharVerification?pan=${panNumber}`); // Navigate to AadharVerification with PAN number
...
//         <Image src="/images/pancard.png" width={500} height={500} alt="Pan Card" />
...
//         <label htmlFor="panNumber" className={styles.label}>Enter PAN Number</label>
//         <input
//           id="panNumber"
//           type="text"
...
//             <p>You are agreeing with all details and information provided, and you are ready to go further.</p>
//             <button className={styles.closeButton} onClick={() => setShowTermsModal(false)}>Close</button>
//           </div>
//         </div>
//       )}
//     </div>
